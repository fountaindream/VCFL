...
def resnet18(pretrained=False):
  ...
  if pretrained:
    ...
    model.load_state_dict(remove_fc(torch.load(models['resnet18'])))
  return model
...
def resnet34(pretrained=False):
  ...
  if pretrained:
    ...
    model.load_state_dict(remove_fc(torch.load(models['resnet34'])))
  return model
...
def resnet50(pretrained=False):
  ...
  if pretrained:
    ...
    model.load_state_dict(remove_fc(torch.load(models['resnet50'])))
  return model
...
def resnet101(pretrained=False):
  ...
  if pretrained:
    ...
    model.load_state_dict(
      remove_fc(torch.load(models['resnet101'])))
  return model
...
def resnet152(pretrained=False):
  ...
  if pretrained:
    ...
    model.load_state_dict(
      remove_fc(torch.load(models['resnet152'])))
  return model
